...
public class SetDeltaImpl<E> implements Delta {
    ...
    public SetDeltaImpl(
        ...
        this.added_f = (recordAdded ? new HashSet<E>() : null );
        this.removed_i = (recordRemoved ? new HashSet<E>() : null );
        this.still_f = (recordStill ? new HashSet<E>() : null );
    }
    ...
    public void subtract(Set<E> set_f, Set<E> set_i) {
        if ( ((set_f == null) || set_f.isEmpty()) &&
             ((set_i == null) || set_i.isEmpty()) ) {
