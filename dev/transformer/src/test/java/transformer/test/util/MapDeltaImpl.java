    ...
    public void log(PrintWriter writer) {
        ...
        if ( addedMap == null ) {
            ...
            for ( Map.Entry<K, V> addedEntry : addedMap.entrySet() ) {
                if ( addedNo > 3 ) {
                    writer.println(prefix + "  [ ... " + addedMap.entrySet().size() + " ]");
                    break;
                } else {
        ...
        if ( removedMap == null ) {
            ...
            for ( Map.Entry<K, V> removedEntry : removedMap.entrySet() ) {
                if ( removedNo > 3 ) {
                    writer.println(prefix + "  [ ... " + removedMap.entrySet().size() + " ]");
                    break;
                } else {
                    writer.println(prefix +
                    	"  [ " + removedNo + " ] " + 
        ...
        if ( changedMap == null ) {
            ...
            for ( Map.Entry<K, V[]> changedEntry : changedMap.entrySet() ){
                if ( changedNo > 3 ) {
                    writer.println(prefix + "  [ ... " + changedMap.entrySet().size() + " ]");
                    break;
                } else {
        ...
        if ( stillMap == null ) {
            ...
            writer.println(prefix + "  [ " + stillMap.entrySet().size() + " ]");
