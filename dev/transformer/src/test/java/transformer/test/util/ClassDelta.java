...
public class ClassDelta implements Delta {
	...
	public ClassDelta(ClassData finalClass, ClassData initialClass) {
		...
		this.staticMethodChanges.subtract( finalClass.getStaticMethodDescriptions(), initialClass.getStaticMethodDescriptions() );
		this.staticMethodAnnoChanges = BiDiMapDeltaImpl.stringDelta("static method", "annotation");
		this.staticMethodAnnoChanges.subtract( finalClass.getStaticMethodAnnotationNames(), initialClass.getStaticMethodAnnotationNames() );		
	}
	...
	public boolean isNull() {
		return
			( !changedClassName && !changedSuperclassName && interfaceNameChanges.isNull() &&
			  fieldChanges.isNull() && fieldAnnoChanges.isNull() &&
			  methodChanges.isNull() && methodAnnoChanges.isNull() &&
			  initChanges.isNull() && initAnnoChanges.isNull() &&
			  staticMethodChanges.isNull() && staticMethodAnnoChanges.isNull() );
	}
